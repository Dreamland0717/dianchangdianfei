...
# 配置文件路径
METER_CONFIG_FILE = os.path.join(INPUT_DIR, "meter_config.json")
...
def initialize_meter_config():
    ...
    if loaded_meter_ids and set(meter_ids).issubset(set(loaded_meter_ids)):
        print("使用现有的电能表配置")
        # 只返回当前需要的电能表配置
